...
Column meaning
--------------
- Act            : Act name, for example Indian Penal Code (IPC) 1860
- Section Number : numeric / alphanumeric section identifier only, for example 176
- Bracket Text   : section heading text only, without the outer brackets when present
- Section        : full display string, for example Section 176: (Omission to give notice or information to public servant by person legally bound to give it)
- Clause         : main section text collected from the expanded dropdown body
- Description    : Explanation / Exception / Illustration / Comment / Note text from the dropdown body
...
4. It parses each section into one row and splits out:
   - Act
   - Section Number
   - Bracket Text
   - Section
